...
# cap = cv2.VideoCapture('D:/Workspace/Vehicle_detection/highway.mp4')
...
# # In ra tổng số khung hình và fps
...
class WebcamStream :
    def __init__(self, stream_id=0):
        self.stream_id = 'D:/Workspace/Vehicle_detection/highway.mp4'   # default is 0 for primary camera 
